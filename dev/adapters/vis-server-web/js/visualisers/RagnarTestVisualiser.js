(function(global){
    ...
    */
    ...
    p.render = function() {
        ...
        // this.sideCtx.fillStyle = "rgba(255,255,0,0.5)";
        ...
        this.movementIndex += 0.1;

        this.combCtx.fillStyle = "white";
        // this.combCtx.fillRect(this.totalWidth - this.movementIndex, 20, 1, 1);
        this.combCtx.fillRect(0, 20, 20, 20);
