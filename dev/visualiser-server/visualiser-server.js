...
var VisualiserManager = require("./js/VisualiserManager.js");
var fs = require("fs");
...
function onExit(err) {
	...
	console.log("** Visualiser exiting, cleaning up... **");
	manager.cleanup();
	process.exit();
}
	...
	if (queryComponents["method"]){
		...
		switch(method){
			...
			case "debug":
				...
				responseText = fs.readFileSync("./html/debugViewVisualiser.html", "utf8");
