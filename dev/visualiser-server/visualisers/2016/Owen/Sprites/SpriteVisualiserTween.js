...
var SPRITE_LIBRARY = require("./SpriteLibrary.js");
var Canvas = require("canvas");
	...
	*/
	...
	p.render = function() {
		...
		this.combCtx.fillStyle = "rgba(0,0,0,0.3)";
	...
	p.drawSprite = function(cx,cy,spriteFrame, alpha, white) {
		...
		this.combCtx.strokeStyle = "rgba(255,255,255," + Math.pow(white, 4) + ")";
		this.combCtx.lineWidth = 0.15;
...
module.exports = SpriteVisualiser;
